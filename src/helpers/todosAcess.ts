...
async createComment(todoId: string, userId: string, newComment: String,esComment:String):  Promise<void> {
    ...
    await this.docClient.update({
      ...
      UpdateExpression: "set comments = :comments, comments_esp = :comments_esp",
      ExpressionAttributeValues: {
       ":comments": newComment,
       ":comments_esp":esComment
     }
    }).promise()
